...
Vous êtes sur la page de la **version 3.5.4** du plugin Assessment Path, dernière version compatible avec **Moodle 3.5**.
...
- Télécharger la dernière version du plugin : https://github.com/sfraysse/moodle-assessmentpath/archive/v3.5.4.zip.
